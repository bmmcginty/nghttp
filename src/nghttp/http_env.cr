...
module NGHTTP
  class HTTPEnv
    ...
    alias ConfigValuesType = String | Int32 | Float64 | Bool | Nil | Time::Span | Array(String) | Range(Int32, Int32) | Range(Int64, Int64) | Handler | HTTP::Headers | Transport | URI | Proc(String, String?) | Proc(String, String) | OpenSSL::SSL::Context::Client | Hash(String, String) | FilesType | IO | Array(Int32)
